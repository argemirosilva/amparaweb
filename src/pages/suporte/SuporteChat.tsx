...
const SENDER_STYLES: Record<string, { bg: string; text: string; align: string; label: string }> = {
  agent: { bg: "hsl(220 10% 66%)", text: "hsl(220 10% 10%)", align: "ml-auto", label: "Agente" },
  user: { bg: "hsl(220 10% 88%)", text: "hsl(220 10% 10%)", align: "mr-auto", label: "Usuária" },
                  ...
                  <div className="rounded-lg px-3 py-2" style={{ background: style.bg }}>
                    ...
                    {wasRedacted && (
                      <p className="text-[10px] mt-1 flex items-center gap-1" style={{ color: "hsl(220 13% 46%)" }}>
                        ...
                        Dados sensíveis omitidos por segurança e privacidade
                      </p>
                    )}
