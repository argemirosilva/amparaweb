  ...
  return (
    <div className="min-h-[100dvh] flex flex-col md:flex-row bg-background">
      ...
      <div className="hidden md:flex md:w-[45%] lg:w-[50%] relative flex-col items-center justify-end p-12 overflow-hidden bg-gradient-to-br from-primary/5 via-background to-ampara-magenta/5">
        ...
        {/* Illustration — flipped horizontally, full panel height */}
        <img
          src={loginIllustration}
          alt=""
          className="absolute bottom-0 left-0 w-[90%] h-[90%] object-contain object-left-bottom pointer-events-none select-none opacity-25"
