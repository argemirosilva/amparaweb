  ...
  const { data: consulta, error: insertError } = await supabase
    ...
    .insert({
      ...
      output_json: {
        ...
        despacho: resDespacho.error ? null : (resDespacho.outputText || null),
        parecer: resParecer.error ? null : (resParecer.outputText || null),
        despacho_error: resDespacho.error || null,
        parecer_error: resParecer.error || null,
        analitico_error: resAnalitico.error || null,
      },
      output_text: null,
      usuario_id: usuario?.id || null,
      agressor_id: agressor?.id || null,
